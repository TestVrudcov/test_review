create procedure syn.usp_ImportFileCustomerSeasonal
	@ID_Record int
-- 1. Все ключевые слова пишутся в нижнем регистре
AS
set nocount on
begin
	-- 2. Следует использовать один раз "declare"	
...
-- Проверка на корректность загрузки
	...
	if not exists (
	-- 4. Этот блок кода также должен быть с отступом от уровня кода с if 
	select 1
